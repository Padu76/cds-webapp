...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-emerald-50">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-xs text-gray-600">AI Assistant Specializzato</p>
              </div>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 lg:py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          ...
          <button
            ...
            className="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 border-2 border-transparent hover:border-emerald-200 text-left w-full"
          >
            <div className="flex items-center space-x-4 mb-4">
              <div className="w-16 h-16 bg-gradient-to-r from-emerald-500 to-green-400 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
              ...
              <div>
                ...
                <p className="text-emerald-600 font-medium">Diossido di Cloro</p>
              </div>
            </div>
          ...
          <button
            ...
            className="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 border-2 border-transparent hover:border-blue-200 text-left w-full"
          >
            <div className="flex items-center space-x-4 mb-4">
              <div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-indigo-400 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
              ...
              <div>
                ...
                <p className="text-blue-600 font-medium">Neuroprotettore</p>
              </div>
            </div>
            <p className="text-gray-600 leading-relaxed mb-4">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-8">
          {[
            ...
            <div key={index} className="text-center bg-white/70 backdrop-blur-sm p-4 lg:p-6 rounded-xl shadow-md">
              <div className={`text-2xl lg:text-3xl font-bold text-${stat.color}-600 mb-2`}>
                {stat.number}
              </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 lg:py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {[
            ...
            <div key={index} className="group bg-white p-6 lg:p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
      ...
      {/* Trust Section */}
      <section className="bg-gradient-to-r from-gray-50 to-blue-50 py-16 lg:py-20">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={index} className="flex items-start space-x-4">
                    <div className="w-12 h-12 bg-gradient-to-r from-emerald-500 to-cyan-500 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg">
              ...
              <div className="grid grid-cols-2 gap-6">
                {[
                  ...
                  <div key={index} className="text-center p-6 bg-gray-50 rounded-xl hover:shadow-md transition-shadow">
                    <stat.icon className={`w-10 h-10 text-${stat.color}-600 mx-auto mb-3`} />
      ...
      {/* CTA Section */}
      <section className="max-w-7xl mx-auto px-4 py-16 lg:py-20">
        <div className="bg-gradient-to-r from-emerald-500 to-cyan-500 rounded-2xl lg:rounded-3xl p-8 lg:p-12 text-white text-center shadow-2xl">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            Inizia subito con il tuo assistente AI
          </h2>
          <p className="text-lg lg:text-xl opacity-90 mb-8 max-w-3xl mx-auto leading-relaxed">
      ...
      >
        <div className="space-y-6">
          <div className="flex items-center space-x-4 p-4 bg-emerald-50 rounded-xl">
            ...
            <div>
              <h4 className="font-semibold text-emerald-900">Formula Chimica</h4>
              <p className="text-emerald-700">ClO₂ - Diossido di Cloro</p>
            </div>
          </div>
          
          <div>
            <h4 className="font-semibold text-gray-900 mb-3">Cos'è il CDS?</h4>
          ...
          <div>
            <h4 className="font-semibold text-gray-900 mb-3">Meccanismo d'Azione</h4>
          ...
          <div>
            <h4 className="font-semibold text-gray-900 mb-3">Indicazioni Principali</h4>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="p-3 bg-gray-50 rounded-lg">
                <h5 className="font-medium text-gray-900">Infezioni Acute</h5>
                <p className="text-sm text-gray-600">Batteriche, virali, fungine</p>
              </div>
              <div className="p-3 bg-gray-50 rounded-lg">
                <h5 className="font-medium text-gray-900">Supporto Immunitario</h5>
                <p className="text-sm text-gray-600">Rafforzamento delle difese</p>
              </div>
              <div className="p-3 bg-gray-50 rounded-lg">
                <h5 className="font-medium text-gray-900">Detossificazione</h5>
                <p className="text-sm text-gray-600">Eliminazione tossine</p>
              </div>
              <div className="p-3 bg-gray-50 rounded-lg">
                <h5 className="font-medium text-gray-900">Parassiti</h5>
                <p className="text-sm text-gray-600">Protocolli antiparassitari</p>
              </div>
            </div>
          </div>

          <div className="bg-amber-50 border border-amber-200 rounded-xl p-4">
            <h4 className="font-semibold text-amber-900 mb-2">⚠️ Note Importanti</h4>
      ...
      >
        <div className="space-y-6">
          <div className="flex items-center space-x-4 p-4 bg-blue-50 rounded-xl">
            ...
            <div>
              <h4 className="font-semibold text-blue-900">Formula Chimica</h4>
              <p className="text-blue-700">C₁₆H₁₈ClN₃S - Blu di Metilene</p>
            </div>
          </div>
          
          <div>
            <h4 className="font-semibold text-gray-900 mb-3">Cos'è il Blu di Metilene?</h4>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="p-3 bg-gray-50 rounded-lg">
                <h5 className="font-medium text-gray-900">Alzheimer</h5>
                <p className="text-sm text-gray-600">Supporto cognitivo</p>
              </div>
              <div className="p-3 bg-gray-50 rounded-lg">
                <h5 className="font-medium text-gray-900">Parkinson</h5>
                <p className="text-sm text-gray-600">Neuroprotezzione</p>
              </div>
              <div className="p-3 bg-gray-50 rounded-lg">
                <h5 className="font-medium text-gray-900">Depressione</h5>
                <p className="text-sm text-gray-600">Supporto dell'umore</p>
              </div>
              <div className="p-3 bg-gray-50 rounded-lg">
                <h5 className="font-medium text-gray-900">Long COVID</h5>
                <p className="text-sm text-gray-600">Recupero neurologico</p>
              </div>
            </div>
          </div>

          <div>
            <h4 className="font-semibold text-gray-900 mb-3">Caratteristiche Uniche</h4>
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                <span className="text-gray-600">Colorazione temporanea blu-verde delle urine (normale)</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                <span className="text-gray-600">Migliore assorbimento se assunto con il cibo</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                <span className="text-gray-600">Effetto cumulativo - benefici crescenti nel tempo</span>
              </div>
            </div>
          </div>

          <div className="bg-red-50 border border-red-200 rounded-xl p-4">
            <h4 className="font-semibold text-red-900 mb-2">⚠️ Controindicazioni Importanti</h4>
      ...
      <footer className="bg-gray-900 text-white py-12 lg:py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="lg:col-span-2">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold">CDS Wellness</h3>
                  <p className="text-gray-400 text-sm">AI Assistant Specializzato</p>
                </div>
              </div>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p className="mb-2">&copy; 2024 CDS Wellness. Powered by AI per protocolli CDS e Blu di Metilene.</p>
            <p className="text-sm">
